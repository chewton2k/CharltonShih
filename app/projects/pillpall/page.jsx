  ...
  return (
    <section className="pillpall-section">
      ...
      <div className="pillpall-gallery">
        <img src="/pillpall.png" alt="PillPal screen 1" onClick={() => openLightbox("/pillpall.png")} />
        <img src="/pillpall2.png" alt="PillPal screen 2" onClick={() => openLightbox("/pillpall2.png")} />
        <img src="/pillpall3.png" alt="PillPal screen 3" onClick={() => openLightbox("/pillpall3.png")} />
        <img src="/pillpall4.png" alt="PillPal screen 4" onClick={() => openLightbox("/pillpall4.png")} />
        <img src="/pillpall5.png" alt="PillPal screen 5" onClick={() => openLightbox("/pillpall5.png")} />
      </div>

      {lightboxSrc && (
        <div className="pillpall-lightbox" onClick={closeLightbox} role="dialog" aria-modal="true">
          <div className="pillpall-lightbox-inner">
            <img src={lightboxSrc} alt="PillPal enlarged view" />
          </div>
        </div>
      )}
    </section>
