        ...
        <div className="projects-grid">
          ...
          <div className="project-card with-image">
            <div className="project-media">
               <img src="/imprint.png" alt="Imprint" />
          ...
          <div className="project-card with-image">
            <div className="project-media">
               <img src="/UCLAdesign.png" alt="UCLA Design" />
               <div className="media-overlay">
                  <Link href="/projects/ucla-design" className="overlay-link">View Details</Link>
               </div>
            </div>
            <div className="project-info">
          ...
          <div className="project-card with-image">
            <div className="project-media">
               <img src="/btd.png" alt="BTD Training Camp" />
               <div className="media-overlay">
          ...
          <div className="project-card with-image">
            <div className="project-media">
               <img src="/hourtrack.png" alt="HourTrack" />
               <div className="media-overlay">
          ...
          <div className="project-card with-image">
            <div className="project-media">
               <img src="/pillpall.png" alt="PillPal" />
               <div className="media-overlay">
                  <Link href="/projects/pillpall" className="overlay-link">View Details</Link>
               </div>
            </div>
            <div className="project-info">
